    ...
    >
      <div className={`w-full flex justify-evenly items-center overflow-hidden`}>
        <div className={`flex flex-col`}>
          ...
          <p className={`text-lg lg:text-4xl text-left lg:pt-8 pl-4 lg:px-16`}>Neste serviço é realizado a limpeza e remoção de resíduos como poeira. Substituição de pasta térmica do processador e efetuado um check-up dos hardwares na tentativa de prever possíveis equipamentos defeituosos.</p>
        </div>
